    ...
    <section className="pricing container section">
      ...
      <div className="pricing__container grid">
        <div className="pricing__item">
          ...
          <p className="pricing__title">Simple Option 123</p>
          <p className="pricing__support">Gmail support</p>
          <h3 className="price">
        ...
        <div className="pricing__item best">
          ...
          <p className="pricing__title">Unlimited prpuct icluding</p>
        ...
        <div className="pricing__item">
          ...
          <p className="pricing__title">A wise option a large companies</p>
